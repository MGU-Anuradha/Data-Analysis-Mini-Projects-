...
-- raw data set : https://www.kaggle.com/datasets/swaptr/layoffs-2022
...
-- Create a staging table to copy all raw data
CREATE TABLE layoffs_staging 
LIKE layoffs;

-- Insert all raw data in to the staging table
...
-- Is to create a new column and add those row numbers in. 
...
-- Done...
-- Now the data in our raw data set is mostly cleaned.
-- Now we can use this cleaned data for analysis.
